// ============================================
// Check-Out Step 1 — Enter Booking Info
// ============================================
...
export default function EnterBooking({ onNext, onBack }) {
  const { setCheckoutBookingId } = useKiosk();
    ...
    <div className="flex flex-col items-center w-full max-w-2xl mx-auto gap-6 animate-fade-in">
      <div className="text-center">
        ...
        <p className="text-lg text-[var(--color-gray-500)]">
          Insert your key card or enter booking details
        </p>
      </div>
